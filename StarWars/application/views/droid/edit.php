...
<html lang="en-US">
    ...
    <body>
        ...
        <?php echo form_input('name',$droid->name,['placeholder' => 'Name']); ?>
        <?php echo form_error('name'); ?>
        <br/>
        
        <?php echo form_input('homeworld',$droid->homeworld,['placeholder' => 'Homeworld']); ?>
        <?php echo form_error('homeworld'); ?>
        <br/>
        
        <?php echo form_input('creator',$droid->creator,['placeholder' => 'Creator']); ?>
        ...
        <?php echo form_input('class',$droid->class,['placeholder' => 'Class']); ?>
        ...
        <p class='back'><a href="<?=base_url('droid')?>">Back</a></p><?php $this->load->view('footer'); ?>
    </body>
</html>
