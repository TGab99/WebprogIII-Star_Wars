...
<html lang="en-US">
    ...
    <body>
        ...
        <?php echo form_input('homeworld',$clone->homeworld,['placeholder' => 'Homeworld']); ?>

        <?php echo form_error('homeworld'); ?>
        <br/>

        <?php echo form_input('species',$clone->species,['placeholder' => 'Species']); ?>

        <?php echo form_error('species'); ?>
        <br/>

        <?php echo form_input('gender',$clone->gender,['placeholder' => 'Gender']); ?>

        <?php echo form_error('gender'); ?>
        <br/>

        <?php echo form_input('rank',$clone->rank,['placeholder' => 'Rank']); ?>
