...
/**
 * Description of Mandalorians
 *
 * @author Acer
 */
class Mandalorians extends CI_Controller{
    public function __construct() {
        parent::__construct();
        
        $this->load->model('mandalorians_model');
    }
    
    public function index(){
        
        $records = $this->mandalorians_model->get_list();
        ...
        $this->load->view('mandalorians/list',$view_params);
    }
    ...
    public function insert(){
        if($this->input->post('submit')){
            ...
            $upload_config['upload_path'] = './uploads/image/mandalorians/';
            ...
            if($this->form_validation->run() && $this->upload->do_upload('file') == TRUE){
                ...
                $this->load->helper('url');
                redirect(base_url('mandalorians'));
            }
        }
        $this->load->helper('form');
        $this->load->view('mandalorians/insert');
    }
    ...
    public function profile($id = NULL){
        ...
        $this->load->helper('form');
        $this->load->view('mandalorians/profile',$view_params);
    }
    ...
    public function edit($id = NULL){
        ...
        if($this->form_validation->run() == TRUE){
            ...
            $this->load->helper('form');
            $this->load->view('mandalorians/edit',$view_params);
        }
    }
